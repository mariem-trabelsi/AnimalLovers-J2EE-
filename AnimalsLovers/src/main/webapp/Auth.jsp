...
<form style="background: linear-gradient(0.39turn,#87CEFA,white, #25b2a2);" method="POST"  action="Login" style=" width:100%;padding: 30px;border: 1px solid #f1f1f1;background: #fff;box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);">
<table>
<tr>
...
<a style="text-decoration:none;color:blue" href="form2.jsp">Se connecter comme étant un client </a>
